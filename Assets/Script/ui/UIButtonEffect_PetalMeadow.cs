...
public class UIButton_PetalMeadow : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler, IPointerDownHandler, IPointerUpHandler
{
    ...
    {
        transform.DOScale(_originalScale * scaleFactor, duration * 0.5f).SetEase(Ease.OutBack);
    }
}
